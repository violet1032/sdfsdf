package com.xcinfo.xc_blueteeth_android.common.qrsacan.zxing;
...
import com.xcinfo.xc_blueteeth_android.common.qrsacan.zxing.decode.PhotoScanHandler;
import com.xcinfo.xc_blueteeth_android.common.qrsacan.zxing.decode.RGBLuminanceSource;
import com.xcinfo.xc_blueteeth_android.common.qrsacan.zxing.utils.BeepManager;
import com.xcinfo.xc_blueteeth_android.common.qrsacan.zxing.utils.BitmapUtil;
import com.xcinfo.xc_blueteeth_android.common.qrsacan.zxing.utils.CaptureActivityHandler;
import com.xcinfo.xc_blueteeth_android.common.qrsacan.zxing.utils.InactivityTimer;
...
public class ScanManager implements SurfaceHolder.Callback{
	...
	public ScanManager(Activity activity, SurfaceView scanPreview, View scanContainer,
					   View scanCropView, ImageView scanLine, int scanMode
			, ScanListener listener,TextView lightView) {
	...
	public void switchLight(){
		if(isOpenLight){
			...
			lightView.setBackground(activity.getResources().getDrawable(R.drawable.light_off));
		}else{
			cameraManager.openLight();
			lightView.setBackground(activity.getResources().getDrawable(R.drawable.light_on));
		}
